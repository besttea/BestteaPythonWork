...
#转换为灰度并且使其产生中等的模糊
    img_gray = cv2.cvtColor(img_blurcolor, cv2.COLOR_RGB2GRAY)
...
for filename in os.listdir(r"./testimg/"):
